...
module.exports = function(options) {
  var args, count, dir, finish, loading, plugin, submodules, tgz, url, _base, _base1, _base2, _base3, _finish;
  if (options == null) {
    options = {};
  }
  ...
  switch (options.method) {
    case 'release':
      ...
      if ((_base = options.mapping).dojo == null) {
        _base.dojo = path.resolve(dir, "dojo");
      }
      if ((_base1 = options.mapping).dijit == null) {
        _base1.dijit = path.resolve(dir, "dijit");
      }
      if ((_base2 = options.mapping).dojox == null) {
        _base2.dojox = path.resolve(dir, "dojox");
      }
      if ((_base3 = options.mapping).util == null) {
        _base3.util = path.resolve(dir, "util");
      }
    ...
    case 'git':
      ...
      submodules.forEach(function(submodule) {
        var checkout, clone, revision, _base4;
        revision = options["" + submodule + "_revision"] || 'HEAD';
        if ((_base4 = options.mapping)[submodule] == null) {
          _base4[submodule] = "git-" + submodule + "-" + revision;
        }
